...
public class FileIndexTester {
	...
	public static final String INPUT_FOLDER_1 = "./resources/input_1";
	public static final String INPUT_FOLDER_2 = "./resources/input_2";
	public static final String INPUT_FOLDER_3 = "./resources/input_3";
	...
	public static void main(String[] args){
		testTFIDF();
		testSortingBySignificance();
		testCosineSimilarity();
		testSortingByCosineSimilarity();
	}
	...
	public static void testSortingBySignificance(){
		...
		try{
			...
			System.out.println(fIndex.getTFIDF("he",fileName));
			System.out.println(fIndex.getTFIDF("he",fileName)==fIndex.getTFIDF("his",fileName));
